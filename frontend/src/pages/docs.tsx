...
const copy = {
  en: {
    ...
    sidebarGroups: [
      {
        ...
        items: [
          ...
          ['Create first workspace', '#workspace'],
          ['Connect data', '#datasource'],
        ],
      },
      {
        title: 'Use MetricFlow',
        items: [
          ['Run SQL queries', '#queries'],
    ...
    articles: [
      ...
      },
      {
        ...
        description: 'Use the one-time setup flow to create the organization owner for a self-hosted installation.',
        href: '#workspace',
      },
      {
        category: 'Connect data',
        title: 'Connect a datasource safely',
        description: 'Add analytical connections with least-privilege credentials and validate them before saving.',
        href: '#datasource',
      },
      {
        category: 'Use MetricFlow',
        title: 'Run and save SQL queries',
        description: 'Execute read-only SQL, inspect results, and save reusable queries for dashboards and widgets.',
        href: '#queries',
      },
      {
        category: 'Use MetricFlow',
        title: 'Build and share dashboards',
        description: 'Compose dashboard widgets, review sensitive fields, and share public links only when appropriate.',
        href: '#dashboards',
      },
      {
        category: 'Community',
        title: 'Contribute to the project',
        description: 'Open focused pull requests, run validation checks, and document user-facing changes.',
        href: '#contributing',
      },
  ...
  es: {
    ...
    sidebarGroups: [
      {
        ...
        items: [
          ...
          ['Crear primer espacio', '#workspace'],
          ['Conectar datos', '#datasource'],
        ],
      },
      {
        ...
        items: [
          ...
          ['Construir dashboards', '#dashboards'],
          ['Compartir dashboards', '#dashboards'],
        ],
      },
      {
        title: 'Comunidad',
    ...
    articles: [
      ...
      {
        category: 'Primeros pasos',
        title: 'Crear el primer espacio de trabajo',
        description: 'Usa el setup único para crear la cuenta propietaria de una instalación self-hosted.',
        href: '#workspace',
      },
      {
        category: 'Conectar datos',
        title: 'Conectar una fuente de datos segura',
        description: 'Agrega conexiones analíticas con credenciales mínimas y valídalas antes de guardar.',
        href: '#datasource',
      },
      {
        category: 'Usar MetricFlow',
        title: 'Ejecutar y guardar consultas SQL',
        description: 'Ejecuta SQL de solo lectura, revisa resultados y guarda consultas reutilizables.',
        href: '#queries',
      },
      {
        category: 'Usar MetricFlow',
        title: 'Construir y compartir dashboards',
        description: 'Compón widgets, revisa campos sensibles y comparte enlaces públicos solo cuando corresponda.',
        href: '#dashboards',
      },
      {
        category: 'Comunidad',
        title: 'Contribuir al proyecto',
        description: 'Abre pull requests enfocados, ejecuta validaciones y documenta cambios visibles para usuarios.',
        href: '#contributing',
      },
    ] satisfies DocArticle[],
  },
